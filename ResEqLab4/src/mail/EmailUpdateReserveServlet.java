...
public class EmailUpdateReserveServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			msg.setSubject("Your reservation has been updated");
			String msgBody = "Your new reservation details are: \n \n - Resource: "
					+ title + "\n - Hour : " + starthour
					+ "\n - Date: " + startdate+"\n";
