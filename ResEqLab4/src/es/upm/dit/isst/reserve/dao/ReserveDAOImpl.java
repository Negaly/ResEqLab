...
public class ReserveDAOImpl implements ReserveDAO {
	...
	@Override
	public void add(String starthour, String endhour, String startdate, String enddate, String user) {
		synchronized (this) {
			EntityManager em = EMFService.get().createEntityManager();
			
			Reserve reserve = new Reserve(starthour, endhour, startdate, enddate, user);
			em.persist(reserve);
			em.close();
		}
